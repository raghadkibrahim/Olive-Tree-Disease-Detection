...
My grandfather was an Arabic teacher, and one poet whose work he enjoyed was Mahmoud Darwish. Growing up, he used to tell us grandkids stories about his trees and would often refer to the trees using female names, and I never understood exactly why until I read Mahmoud Darwish's poetry myself as an adult. Author Fady Joudah who translated a collection of Darwish's poetry speaks about it in his translation "A Butterfly's Burden": 
...
While AI is being used to carry out brutal bombing campaigns, I would like to use it to help heal the Olive Trees he loved so dearly. The way people have been fighting for Palestine made me believe in the power of data, because all it took was the world knowing the one truth for the tides to turn.
